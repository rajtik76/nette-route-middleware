<?php
// source: /Users/rajtik/PhpstormProjects/NetteProjects/nette-route-middleware/config/common.neon
// source: /Users/rajtik/PhpstormProjects/NetteProjects/nette-route-middleware/config/services.neon
// source: array
...
class Container_b2cdd33ca2 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Interfaces\MiddlewareInterface' => [['02']],
		'App\Http\Middleware\DenyMiddleware' => [['02']],
	...
	public function createService02(): App\Http\Middleware\DenyMiddleware
	{
		return new App\Http\Middleware\DenyMiddleware;
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/Users/rajtik/PhpstormProjects/NetteProjects/nette-route-middleware/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/Users/rajtik/PhpstormProjects/NetteProjects/nette-route-middleware/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'/Users/rajtik/PhpstormProjects/NetteProjects/nette-route-middleware/temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_b2cdd33ca2 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/Users/rajtik/PhpstormProjects/NetteProjects/nette-route-middleware/temp/cache/latte');
